...
[api reference]: {{ site.v1xgdeurl }}/api/rest/rest-api-index.html[application/x-www-form-urlencoded]: https://www.w3.org/TR/html401/interact/forms.html#h-17.13.4.1
{:target="_blank"}
