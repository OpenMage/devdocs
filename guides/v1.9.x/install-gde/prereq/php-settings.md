...
layout: default
---
This topic discusses how to set required [PHP](https://glossary.magento.com/php/){:id: class="glossary-term"}
 options.
 {% include install/php-versions-1.9.md %}
...
If [PHP](https://glossary.magento.com/php/){:id: class="glossary-term"} is installed, a message similar to the following displays:
```terminal
...
{% assign packages = site.data.codebase.v19.composer_lock.packages %}
